...
app.get('/', async (c) => {
  try {
    ...
    return c.html(
      <html>
        <body style="font-family:sans-serif;padding:2rem;background:#0a0e1a;color:#f87171;">
          <h1>Database Connection Error</h1>
          <p>{err.message}</p>
          <pre style="background:#1e293b;padding:1rem;border-radius:8px;overflow:auto;color:#94a3b8;margin-top:1rem;">
            {err.stack}
          </pre>
        </body>
      </html>,
